 ...
 * @OA\Tag(
 *     name="V2 Posts",
 *     description="Operations for managing posts in version 2 of the API"
 * )
 */
...
class PostController extends Controller
{
     ...
     *                 property="data",
     *                 type="array",
     *                 @OA\Items(ref="#/components/schemas/PostResourceV2")
     *             ),
     ...
     *             @OA\Property(
     *                 property="data",
     *                 ref="#/components/schemas/PostResourceV2"
     *                 ),
     *          ),
     *     ),
     *      @OA\Response(
